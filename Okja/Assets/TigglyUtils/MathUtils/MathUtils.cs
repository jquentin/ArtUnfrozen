...
public static class MathUtils 
{
	...
	public static List<int> RangeList(int start, int end)
	{
		return Enumerable.Range(start, end - start + 1).ToList();
	}

	public static List<int> DecomposeInDigits(this int number)
	{
		return DecomposeInDigits(number, 0);
	}

	public static List<int> DecomposeInDigits(this int number, int minDigits)
	{
		...
		if (digits.Count < minDigits)
		{
			for (int i = 0 ; i < minDigits - digits.Count ; i++)
				digits.Insert(0, 0);
		}
		return digits;
	}
	...
	/// <summary>
	/// Returns the trigonometrical angle associated with this vector.
	/// </summary>
