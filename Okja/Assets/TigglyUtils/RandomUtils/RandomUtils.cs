...
public static class RandomUtils {
	...
	public static List<Type> RandomDifferentValuesInList<Type>(int nbValues, List<Type> elements, List<Type> excluding = null)
	{
		...
		{
			Debug.LogError(string.Format("Calling RandomList with a list smaller than the number of different elements expected : nbValues = {0} ; elements = {1} ; excluding = {2}", nbValues, elements.ToStringInDepth(), excluding.ToStringInDepth()));
			return null;
		}
