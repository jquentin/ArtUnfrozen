...
public class RandomExhaust<Type>
{
	...
	protected List<Type> lastPicked = new List<Type>();
	...
	protected virtual void SaveExcludingList()
	{
	...
	protected virtual void LoadExcludingList()
	{
		XmlSerializer formatter = new XmlSerializer(lastPicked.GetType());
...
//		}
	...
	protected void AddToExcludingList(Type element)
	{
...
//	}
	...
	protected string PrintLastPicked()
	{
