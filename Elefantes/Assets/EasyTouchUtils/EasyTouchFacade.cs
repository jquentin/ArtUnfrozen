...
public class EasyTouchFacade : MonoBehaviour {
    ...
    void HandleOn_SimpleTap (Gesture gesture)
	{
		if (gesture.pickedObject != null)
		{
			...
			gesture.pickedObject.SendMessageUpwards("OnETMouseUpAsButtonIncludingChildren", gesture, SendMessageOptions.DontRequireReceiver);
		}
	}
	...
	void HandleOn_TouchStart (Gesture gesture)
	{
		if (gesture.pickedObject != null)
		{
			...
			gesture.pickedObject.SendMessageUpwards("OnETMouseDownIncludingChildren", gesture, SendMessageOptions.DontRequireReceiver);
		}
	}
	...
	void HandleOn_TouchUp (Gesture gesture)
	{
		if (gesture.pickedObject != null)
		{
			...
			gesture.pickedObject.SendMessageUpwards("OnETMouseUpIncludingChildren", gesture, SendMessageOptions.DontRequireReceiver);
		}
	}
	...
	void HandleOn_Drag (Gesture gesture)
	{
		if (gesture.pickedObject != null)
		{
			...
			gesture.pickedObject.SendMessageUpwards("OnETMouseDragIncludingChildren", gesture, SendMessageOptions.DontRequireReceiver);
		}
	}
}
